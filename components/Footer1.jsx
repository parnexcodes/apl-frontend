        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="#" class="flex items-center">
              <img src="stumps.png" class="mr-3 h-8" alt="Logo" />
            ...
            <div class="flex justify-start sm:flex sm:justify-between">
              <div className="pr-8">
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white mt-8">
                  Sponsors
                </h2>
