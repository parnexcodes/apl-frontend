...
function Footer() {
  return (
    <>
      <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800 mt-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="#" className="flex items-center">
              <img src="stumps.png" className="mr-3 h-8" alt="Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
                APL
              </span>
            </a>
            <span className="text-sm text-white pt-4 block">
              A Cricket League Organised By Arya College Of Engineering & IT
            </span>
            <span className="text-sm text-white pt-4 block">
              SP-42 Arya College Of Engineering & I.T.
            </span>
            <span className="text-sm text-white pt-4 block">
              info@aryacollege.in
            </span>
            <div className="flex justify-start sm:flex sm:justify-between">
              <div className="pr-8">
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white mt-8">
                  Sponsors
                </h2>
